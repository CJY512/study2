...
public class OrderService {
    ...
    public OrderResponse createOrder(OrderServiceRequest orderRequest, LocalDateTime registeredDateTime) {
    ...
    private List<Product> findProductsByProductNumbers(List<String> productNumbers) {
        ...
        Map<String, Product> mapper = products.stream()
